      ...
      <FactWrapper>
        ...
        <TextWrapper>
          <Text>
            ...
            describe a mixed drink containing spirits, sugar, water, and
            bitters. The term's first appearance in print dates back to 1806 in
            a New York newspaper called "The Balance and Columbian Repository."
            The editor defined a cocktail as "a stimulating liquor composed of
            spirits of any kind, sugar, water, and bitters." This definition
            laid the foundation for the diverse world of cocktails that we enjoy
            today, with countless variations and creative concoctions.
          </Text>
        </TextWrapper>
      </FactWrapper>
      <FactWrapper>
        ...
        <TextWrapper>
          <Text>
            ...
            cooking methods of fire and preservation techniques to the emergence
            of sophisticated cuisines in royal courts, the story of culinary
            evolution is a testament to human creativity and cultural exchange.
            Exploring the historical roots of ingredients, cooking techniques,
            and the birth of iconic dishes provides a deeper appreciation for
            the artistry and traditions that have shaped the way we enjoy food
            around the world.
          </Text>
        </TextWrapper>
      </FactWrapper>
